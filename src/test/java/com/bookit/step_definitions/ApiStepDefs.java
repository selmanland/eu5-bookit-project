...
//        String finalToken = "Bearer "+ token;
    ...
    public void the_information_about_current_user_from_api_and_database_should_match() {
        ...
        //  System.out.println("apiMap = " + apiMap); // i can not compare map to map , some differences available in apir firstName but in
        // sql firstname, id  in api=57.0 in sql id =57
